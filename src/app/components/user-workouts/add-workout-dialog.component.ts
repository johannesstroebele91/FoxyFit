      ...
      <form (ngSubmit)="onSubmit()" autocomplete="off">
        <div [formGroup]="addWorkoutForm">
          <mat-form-field style="margin: 20px 0; display: block">
            ...
            <mat-error *ngIf="category.invalid">{{ ERROR_MESSAGE }} </mat-error>
          </mat-form-field>
          ...
          <mat-form-field style="margin: 20px 0; display: block; width: 100%">
            ...
            <mat-error *ngIf="date.invalid">{{ ERROR_MESSAGE }} </mat-error>
          </mat-form-field>
...
export class AddWorkoutDialogComponent {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: IAddWorkoutDialogData,
  ...
  onSubmit() {
    ...
    if (user && user.id && this.addWorkoutForm.value.date) {
      this.userService
        .addWorkout(user, this.addWorkoutForm.value.date)
        .subscribe({
